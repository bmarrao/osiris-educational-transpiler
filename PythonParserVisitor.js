...
export default class PythonParserVisitor extends antlr4.tree.ParseTreeVisitor {
	...
	visitParam_star_annotation(ctx) {
	  return this.visitChildren(ctx);
	}
	...
	visitCompare_op_bitwise_or_pair(ctx) {
	  return this.visitChildren(ctx);
	}
