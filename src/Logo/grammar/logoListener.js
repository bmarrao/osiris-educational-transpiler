...
export default class logoListener extends antlr4.tree.ParseTreeListener {
	...
	enterParameterDeclarations(ctx) {
	}

	// Exit a parse tree produced by logoParser#parameterDeclarations.
	exitParameterDeclarations(ctx) {
	}


	// Enter a parse tree produced by logoParser#func_.
	enterFunc_(ctx) {
	}

	// Exit a parse tree produced by logoParser#func_.
	exitFunc_(ctx) {
	}


	// Enter a parse tree produced by logoParser#repeat_.
	enterRepeat_(ctx) {
	}

	// Exit a parse tree produced by logoParser#repeat_.
	exitRepeat_(ctx) {
	}
	...
	// Enter a parse tree produced by logoParser#print_.
	enterPrint_(ctx) {
	}

	// Exit a parse tree produced by logoParser#print_.
	exitPrint_(ctx) {
	}


	// Enter a parse tree produced by logoParser#quotedstring.
	enterQuotedstring(ctx) {
	}

	// Exit a parse tree produced by logoParser#quotedstring.
	exitQuotedstring(ctx) {
	}
