...
export function osiris_builtin_copy(iterable, options = {}) {
...
export function osiris_builtin_int(value, base = 10) {
    if (typeof value === 'boolean') {
        return value ? 1 : 0;
    }
    ...
    if (typeof value === 'string') {
        ...
        if (base === 0) {
            if (remaining.startsWith('0x') || remaining.startsWith('0X')) {
                ...
                detectedBase = 2;
                remaining = remaining.slice(2);
            } else if (remaining.startsWith('0o') || remaining.startsWith('0O')) {
                detectedBase = 8;
                remaining = remaining.slice(2);
            ...
            // Explicit base: Remove prefix if it matches the base
...
export function osiris_builtin_ord(str) {
...
export function osiris_builtin_map(fn, ...iterables) {
...
export function osiris_builtin_enumerate(iterable, start=0) {
...
export function osiris_builtin_divmod(x, y) {
  if (y === 0) {
...
export function osiris_builtin_round(number, precision = 0) {
  const factor = Math.pow(10, precision);
  return (Math.round(number * factor) / factor);
}
export function osiris_builtin_zip(...arrays) {
...
export function osiris_builtin_sorted(iterable, { key = null, reverse = false } = {}) {
  let arr = [...iterable];
  arr.sort((a, b) => {
...
export function osiris_builtin_max(iterable, key = x => x) {
...
export function osiris_builtin_sum(iterable, start = 0) {
  let total = start;
...
export function osiris_builtin_range(start, stop, step = 1) {
  if (stop === undefined) {
    stop = start;
    start = 0;
  }
...
export function osiris_builtin_len(input) {
...
export function osiris_builtin_extend(arr, iterable) {
  arr.push(...iterable);
}
...
export function osiris_builtin_any(iterable){
...
export function osiris_builtin_str(value) {
...
export function osiris_builtin_repr(value) {
...
export function osiris_builtin_get(obj, key, defaultValue = null) {
...
export function osiris_builtin_filter(predicate, iterable) {
...
export function osiris_builtin_all(iterable) {
...
export function osiris_builtin_count(iterable, value, start = 0, end = undefined) {
...
export function osiris_builtin_join(separator, iterable) {
